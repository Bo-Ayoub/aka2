...
<body>
<%session.setAttribute("usans",1);%>
<div class="container my-5 py-5" style="text-align:center; font-size:60px;">
<div class="my-5 pt-5">
<%if((int)session.getAttribute("usans")==(int)session.getAttribute("myans")){
