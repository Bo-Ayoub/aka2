...
<!---------------------------------------Side Div--------------------------------------------------------->
  <div class="col-md-4">
    ...
    <div class="px-5">
    <img src="" class="card-img-top" height="270px" style="border-radius:50%; border-style:solid">
    </div>
    <div class="card-body">
      <h5 class="card-title">About Me</h5>
      <p class="card-text">Hello, My name is Ayoub. I am an Undergraduate Computer Science Student 
      I've used HTML, CSS, JavaScript, Bootstrap, Core Java, JSP and Java JDBC to create this website.
         
      <p><h6>My Email:</h6><a href="https://mail.google.com/mail/">Boussaidi-Ayoub@hotmail.com</a></p>
